...
export class CountryListComponent implements OnInit {
  ...
  constructor() {
    this.countryNames = [
            ...
            {	id:	145	,name:"Rwanda"},
            {	id:	146	,name:"St Kitts & Nevis"},
            {	id:	147	,name:"St Lucia"},
            {	id:	148	,name:"Saint Vincent & the Grenadines"},
            {	id:	149	,name:"Samoa"},
  ...
  onSelection(){
      this.countryParam.onClick(this.selectedCountry);
    }
